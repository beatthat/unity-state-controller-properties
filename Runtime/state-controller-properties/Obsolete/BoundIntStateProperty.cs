...
{
    /// <summary>
    /// Convenience base class for an int state property that is uses an external binding component 
    ...
    public class BoundIntStateProperty<BindingComponent> : IntStateProperty
